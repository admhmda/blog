...
<li class="{{ Request::is('makans*') ? 'active' : '' }}">
    <a href="{!! route('makans.index') !!}"><i class="fa fa-edit"></i><span>Makans</span></a>
</li>

</li><li class="{{ Request::is('testlagis*') ? 'active' : '' }}">
    <a href="{!! route('admin.testlagis.index') !!}"><i class="fa fa-edit"></i><span>Testlagis</span></a>
</li>
